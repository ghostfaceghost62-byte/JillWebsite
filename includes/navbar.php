...
<aside class="admin-sidebar" id="adminSidebar">
    <div class="sidebar-brand-header">
        <a class="sidebar-brand" href="<?=url('admin/index.php')?>">
            <span class="sidebar-brand-full">LIDO DE PARIS</span>
            <span class="sidebar-brand-short" style="display:none;">LDP</span>
        </a>
        <button class="sidebar-toggle-btn" type="button" onclick="toggleAdminSidebar()" aria-label="Toggle Sidebar" title="Collapse / Expand Sidebar">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
        </button>
    </div>
    <span class="sidebar-label">LIDO DE PARIS ADMIN</span>
    <nav aria-label="Admin navigation">
        <a class="<?=$isActive('admin/index.php')?>" href="<?=url('admin/index.php')?>" title="Dashboard">
            <span class="nav-icon">
        ...
        <a class="<?=$isActive('admin/reservations')?>" href="<?=url('admin/reservations/index.php')?>" title="Reservations">
            <span class="nav-icon">
        ...
        <a class="<?=$isActive('admin/rooms')?>" href="<?=url('admin/rooms/index.php')?>" title="Rooms">
            <span class="nav-icon">
        ...
        <a class="<?=$isActive('admin/users')?>" href="<?=url('admin/index.php')?>" title="Guest Management">
            <span class="nav-icon">
            ...
            <span class="nav-text">Guest Management</span>
        </a>
        <a class="<?=$isActive('admin/calendar.php')?>" href="<?=url('admin/calendar.php')?>" title="Calendar Grid">
            <span class="nav-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            </span>
            <span class="nav-text">Calendar Grid</span>
        </a>
        <a class="<?=$isActive('admin/housekeeping.php')?>" href="<?=url('admin/housekeeping.php')?>" title="Housekeeping">
            <span class="nav-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
            </span>
            <span class="nav-text">Housekeeping</span>
        </a>
        <a class="<?=$isActive('admin/reports')?>" href="<?=url('admin/reports/index.php')?>" title="Reports">
            <span class="nav-icon">
        ...
        <a class="<?=$isActive('admin/logs')?>" href="<?=url('admin/logs/index.php')?>" title="Activity Logs">
            <span class="nav-icon">
                <svg width="18" height="18" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
            </span>
            <span class="nav-text">Activity Logs</span>
        </a>
        <a class="<?=$isActive('customer/profile.php')?>" href="<?=url('customer/profile.php')?>" title="Settings">
            <span class="nav-icon">
    ...
    <div class="sidebar-logout">
        <form method="post" action="<?=url('auth/logout.php')?>">
            ...
            <button type="submit" title="Sign out">
                <span class="nav-icon" style="display:inline-flex;">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
                </span>
                <span class="logout-text" style="margin-left:0.5rem;">Sign out</span>
            </button>
        </form>
    </div>
</aside>
<div class="admin-topbar">
    <button class="topbar-icon-btn sidebar-topbar-toggle" type="button" onclick="toggleAdminSidebar()" aria-label="Toggle Navigation Sidebar" title="Collapse / Expand Sidebar">
...
function toggleAdminSidebar() {
    ...
    localStorage.setItem('hotelreserve-admin-sidebar-collapsed', isCollapsed ? 'true' : 'false');
}
</script>
<?php else: ?>
